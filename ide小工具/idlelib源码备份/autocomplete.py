...
class AutoComplete:
            ...
            if mode == ATTRS:
                if what == "":  # Main module names.
                    ...
                    namespace = {**__main__.__builtins__.__dict__,
                                 **__main__.__dict__, **self.extra_dict,**self.root_dict}
    ...
    def get_entity(self, name):
        ...
        return eval(name, {**sys.modules, **__main__.__dict__, **self.extra_dict,**self.root_dict})
